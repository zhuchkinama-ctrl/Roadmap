...
import { AfterContentInit, AfterViewChecked, AfterViewInit, ChangeDetectorRef, ElementRef, EventEmitter, NgZone, OnChanges, OnDestroy, OnInit, QueryList, Renderer2, SimpleChanges, TemplateRef } from '@angular/core';
...
export declare class TableService {
    ...
    isHeaderCheckboxSelection$: import("rxjs").Observable<any>;
...
export declare class Table implements OnInit, AfterViewInit, AfterContentInit, BlockableUI, OnChanges {
    ...
    private window;
    constructor(document: Document, platformId: any, renderer: Renderer2, el: ElementRef, zone: NgZone, tableService: TableService, cd: ChangeDetectorRef, filterService: FilterService, overlayService: OverlayService, config: PrimeNGConfig, domSanitizer: DomSanitizer);
    ngOnInit(): void;
...
export declare class FrozenColumn implements AfterViewChecked {
    private el;
    private zone;
    get frozen(): boolean;
