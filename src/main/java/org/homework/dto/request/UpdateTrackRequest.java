// === CHUNK: UPDATE_TRACK_REQUEST [DTO] ===
// Описание: DTO для обновления трека развития.
...
// [START_UPDATE_TRACK_REQUEST]
/*
 * ANCHOR: UPDATE_TRACK_REQUEST
 * PURPOSE: DTO для обновления трека развития.
 *
 * @PreConditions:
...
// [END_UPDATE_TRACK_REQUEST]
// === END_CHUNK: UPDATE_TRACK_REQUEST ===
